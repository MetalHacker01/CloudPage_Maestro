...
// @version      5.0
// @description  Advanced management tool for Salesforce Marketing Cloud CloudPages and Code Resources with batch operations
...
(async function() {
        ...
        window.fetch = function(...args) {
            return originalFetch.apply(this, args).then(response => {
                ...
                if (token && token.length > 50) {
                    ...
                    // Removed chrome.runtime.sendMessage
                    });
    ...
    async function initializeCloudPageMaestro() {
        ...
        if (!chrome.runtime || !// Removed chrome.runtime.sendMessage
...
async function performEnhancedSearch(searchTerm) {
    ...
    try {
        ...
        const response = await new Promise((resolve, reject) => {
            // Removed chrome.runtime.sendMessagedatekind=local',
